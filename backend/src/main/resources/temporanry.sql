...
DROP TABLE PROGRAM_EXERCISE CASCADE CONSTRAINTS;
...
CREATE TABLE BOOKMARK (
	USER_ID VARCHAR2(100) NOT NULL REFERENCES REGISTRATION_USER(USER_ID) ,
...
-- PROGRAM INSERT
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E1', 5, 5, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E6', 5, 5, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E12', 5, 5, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E8', 5, 3, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E24', 8, 2, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P1','E26', 15, 2, 0);


INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E1', 4, 10, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E6', 3, 10, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E14', 3, 10, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E17', 4, 10, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E22', 3, 10, 0);
INSERT INTO PROGRAM_EXERCISE VALUES('P2', 'E26', 4, 10, 0);


INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E10', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E14', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E9', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E11', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E1', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E5', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E28', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E16', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E22', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E18', 10, 10, 20);
INSERT INTO PROGRAM_EXERCISE VALUES('P3', 'E25', 10, 10, 20);


----------- VOLUME ------------
-- VOLUME TABLE CTEATE
CREATE TABLE VOLUME(
	R_NO VARCHAR2(10) REFERENCES PR(R_NO) ON DELETE CASCADE,
	V_NO VARCHAR2(10) PRIMARY KEY,
	V_REPS NUMBER DEFAULT 0,
	V_SET NUMBER DEFAULT 0,
	V_KG NUMBER DEFAULT 0,
	DO_CHECK VARCHAR2(2) DEFAULT 'F'
	CONSTRAINT VOLUME_DO_CHECK CHECK (DO_CHECK IN('T', 'F'))
);
...
----------- COMMUNITY_BOARD ------------
-- COMMUNITY_BOARD TABLE CREATE
CREATE TABLE COMMUNITY_BOARD(
	CB_NO NUMBER NOT NULL PRIMARY KEY,
	USER_ID VARCHAR2(100) NOT NULL,
	CB_WRITER VARCHAR2(50) NOT NULL,
	CB_TAG VARCHAR2(20) NOT NULL,
	CB_TITLE VARCHAR2(200) NOT NULL,
	CB_CONTENT VARCHAR2(4000) NOT NULL,
	CB_DATE DATE DEFAULT SYSDATES
);
...
CREATE TABLE COMMUNITY_COMMENT (
	CB_NO NUMBER NOT NULL REFERENCES COMMUNITY_BOARD(CB_NO),
	CC_NO NOT NULL,
	CC_WRITER VARCHAR2(100) NOT NULL,
	CC_CONTENT VARCHAR2(4000) NOT NULL,
	CC_DATE DATE DEFAULT SYSDATE,
	CC_DELETE VARCHAR2(2) DEFAULT 'N'
);